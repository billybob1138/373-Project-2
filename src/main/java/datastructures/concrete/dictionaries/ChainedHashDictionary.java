...
public class ChainedHashDictionary<K, V> implements IDictionary<K, V> {
	 ...
	 * contain IDictionary<K, V> objects.
	 *
	 ...
	 * Hints:
	 *
	 * 1. You should add extra fields to keep track of your iteration state. You
	 * can add as many fields as you want. If it helps, our reference
	 * implementation uses three (including the one we gave you).
	 *
	 * 2. Before you try and write code, try designing an algorithm using pencil
	 * and paper and run through a few examples by hand.
	 *
	 * 3. Think about what exactly your *invariants* are. An *invariant* is
	 * something that must *always* be true once the constructor is done setting
	 * up the class AND must *always* be true both before and after you call any
	 ...
	 * this helper method at the start and end of each method if you're running
	 * into issues while debugging.
	 *
	 * (Be sure to delete this method once your iterator is fully working.)
	 *
	 * Implementation restrictions:
	 *
	 * 1. You **MAY NOT** create any new data structures. Iterators are meant to
	 * be lightweight and so should not be copying the data contained in your
